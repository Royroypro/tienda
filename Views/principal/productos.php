...
<!-- Secci n del Breadcrumb Begin -->
<section class="breadcrumb-section" style="background-image: url('<?php echo BASE_URL; ?>public/img/breadcrumb.jpg'); background-size: cover; background-position: center; position: relative;">
    <div class="overlay" style="background-color: rgba(0, 123, 255, 0.5); position: absolute; top: 0; left: 0; right: 0; bottom: 0;"></div>
        <div class="row">
